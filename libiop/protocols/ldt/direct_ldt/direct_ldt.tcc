...
{
    this->codeword_domain_dim_ = libff_liop::log2(this->poly_degree_bound_) + RS_extra_dimensions;
...
void direct_LDT_parameters<FieldT>::print() const
{
    ...
    {
        libff_liop::print_indent(); printf("===WARNING=== Direct LDT security parameter was overridden\n");
    }
    ...
    libff_liop::print_indent(); printf("* codeword domain dimension: %zu\n", this->codeword_domain_dim_);
    ...
    libff_liop::print_indent(); printf("* number of queries: %zu\n", this->num_queries_);
}
