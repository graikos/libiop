...
void holographic_lincheck_parameters<FieldT>::print() const
{
    ...
    {
        libff_liop::print_indent(); printf("===WARNING=== Holographic Multi lincheck security parameter was overridden\n");
    }
    ...
    libff_liop::print_indent(); printf("* interactive repetitions = %zu\n", this->num_repetitions_);
...
void holographic_multi_lincheck<FieldT>::calculate_response_alpha()
{
    ...
    for (size_t repetition = 0; repetition < this->params_.num_repetitions(); repetition++)
    {
        libff_liop::enter_block("Calculate alpha_summation_oracle");
        ...
        libff_liop::enter_block("multi_lincheck compute p_alpha_M");
        ...
        libff_liop::leave_block("multi_lincheck compute p_alpha_M");
        ...
        libff_liop::leave_block("Calculate alpha_summation_oracle");
    }
}
...
void holographic_multi_lincheck<FieldT>::calculate_response_beta()
{
    ...
    for (size_t repetition = 0; repetition < this->params_.num_repetitions(); repetition++)
    {
        libff_liop::enter_block("Calculate beta_summation_oracle");
        ...
        libff_liop::enter_block("Compute rational function over K");
        for (size_t i = 0; i < this->num_matrices_; i++)
        {
        ...
        libff_liop::leave_block("Compute rational function over K");
        ...
        libff_liop::leave_block("Calculate beta_summation_oracle");
    }
}
