...
void basic_lincheck_parameters<FieldT>::print() const
{
    ...
    {
        libff_liop::print_indent(); printf("===WARNING=== Multi lincheck security parameter was overridden\n");
    }
...
{
    libff_liop::enter_block("multi_lincheck: Calculate and submit proof");
    for (size_t i = 0; i < this->params_.multi_lincheck_repetitions(); i++)
    {
    ...
    libff_liop::leave_block("multi_lincheck: Calculate and submit proof");
}
