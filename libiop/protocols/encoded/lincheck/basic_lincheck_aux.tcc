...
void multi_lincheck_virtual_oracle<FieldT>::set_challenge(const FieldT &alpha, const std::vector<FieldT> r_Mz) {
    ...
    libff_liop::enter_block("multi_lincheck compute alpha powers");
    /** Set alpha powers */
    ...
    libff_liop::leave_block("multi_lincheck compute alpha powers");

    libff_liop::enter_block("multi_lincheck compute p_alpha_prime");
    ...
    libff_liop::leave_block("multi_lincheck compute p_alpha_prime");

    /* Set p_alpha_ABC_evals */
    libff_liop::enter_block("multi_lincheck compute p_alpha_ABC");
    ...
    libff_liop::leave_block("multi_lincheck compute p_alpha_ABC");
    ...
    libff_liop::enter_block("multi_lincheck IFFT p_alphas");
    ...
    libff_liop::leave_block("multi_lincheck IFFT p_alphas");
}
...
{
    libff_liop::enter_block("multi_lincheck evaluated contents");
    ...
    libff_liop::leave_block("multi_lincheck evaluated contents");
    return result;
}
