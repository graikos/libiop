...
public:
    ...
    {
        libff_liop::enter_block("fz evaluated contents");
        ...
        libff_liop::leave_block("fz evaluated contents");
...
void encoded_aurora_protocol<FieldT>::register_witness_oracles()
{
     ...
     */
    const std::size_t m = libff_liop::round_to_next_power_of_2(this->constraint_system_->num_constraints());
    const std::size_t n = libff_liop::round_to_next_power_of_2(this->constraint_system_->num_variables());
    ...
    const field_subset<FieldT> &variable_domain)
{
    ...
    const std::size_t input_variable_dim = libff_liop::log2(primary_input_size + 1);
    ...
    const r1cs_auxiliary_input<FieldT> &auxiliary_input)
{
    ...
    libff_liop::enter_block("Compute randomized f_w");
    ...
    libff_liop::leave_block("Compute randomized f_w");
    ...
    */
    libff_liop::enter_block("Compute A/B/Cz");
    ...
    libff_liop::leave_block("Compute A/B/Cz");

    libff_liop::enter_block("Compute f_{A/B/Cz} over codeword domain");
    this->compute_fprime_ABCz_over_codeword_domain(Az, Bz, Cz);
    libff_liop::leave_block("Compute f_{A/B/Cz} over codeword domain");

    /** 3) Submit all the oracles */
    libff_liop::enter_block("Call IOP oracle submission routines");
    ...
    libff_liop::leave_block("Call IOP oracle submission routines");
