...
bool interleaved_rowcheck_protocol<FieldT>::verifier_predicate()
{
    ...
    for (size_t h = 0; h < this->num_interactions_; ++h)
    {
        ...
        libff_liop::enter_block("Rowcheck: equality test (p_0 equals 0 within systematic domain)");
        ...
        for (size_t d = 0; d < this->systematic_domain_size_; ++d)
        {
            ...
            {
#ifdef DEBUG
                libff_liop::print_indent(); printf("For interactive repetition h = %zu and systematic domain location d = %zu,\n", h, d);
        ...
        libff_liop::leave_block("Rowcheck: equality test (p_0 equals 0 within systematic domain)");
        ...
        libff_liop::enter_block("Rowcheck: querying and performing consistency tests");
        for (size_t k = 0; k < this->num_queries_; ++k)
        {
            ...
            {
#ifdef DEBUG
                libff_liop::print_indent(); printf("For interactive repetition h = %zu and query location j = %zu,\n", h, j);
        ...
        libff_liop::leave_block("Rowcheck: querying and performing consistency tests");
    }
