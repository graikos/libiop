    ...
    extended_systematic_domain_handle_(extended_systematic_domain_handle)
{
    ...
    libff_liop::print_indent(); printf("num oracles for vectors / R1CS constraints (m_2): %zu\n", this->num_oracles_vectors_);
...
{
    libff_liop::enter_block("Submit witness oracles");

    libff_liop::enter_block("Generate extended witness and auxiliary witness");
    /* construct z = (1, v, w) */
    ...
    auxiliary_only_witness.insert(auxiliary_only_witness.end(),
                                  auxiliary_input.begin(),
                                  auxiliary_input.end());
    libff_liop::leave_block("Generate extended witness and auxiliary witness");

    libff_liop::enter_block("Perform matrix multiplications");
    ...
    libff_liop::leave_block("Perform matrix multiplications");

    libff_liop::enter_block("Submit input oracles");
    for (size_t i = 0; i < this->num_oracles_input_; ++i)
    {
    ...
    libff_liop::leave_block("Submit input oracles");

    libff_liop::enter_block("Submit vector oracles");
    for (size_t i = 0; i < this->num_oracles_vectors_; ++i)
    {
        const std::size_t start = i * this->systematic_domain_size_;
        const std::size_t end = start + this->systematic_domain_size_;
    ...
    libff_liop::leave_block("Submit vector oracles");
    libff_liop::leave_block("Submit witness oracles");
}
...
{
    libff_liop::enter_block("Calculating and submitting proof");
    ...
    libff_liop::enter_block("Calculating and submitting response: Lincheck A");
    ...
    libff_liop::leave_block("Calculating and submitting response: Lincheck A");
    libff_liop::enter_block("Calculating and submitting response: Lincheck B");
    ...
    libff_liop::leave_block("Calculating and submitting response: Lincheck B");
    libff_liop::enter_block("Calculating and submitting response: Lincheck C");
    ...
    libff_liop::leave_block("Calculating and submitting response: Lincheck C");

    libff_liop::enter_block("Calculating and submitting response: Rowcheck");
    this->rowcheck_->calculate_and_submit_responses();
    libff_liop::leave_block("Calculating and submitting response: Rowcheck");
    libff_liop::leave_block("Calculating and submitting proof");
}
...
bool interleaved_r1cs_protocol<FieldT>::verifier_predicate(const r1cs_primary_input<FieldT> &primary_input)
{
    ...
    libff_liop::enter_block("Getting Lagrange coefficients for Lincheck tests");
    ...
    libff_liop::leave_block("Getting Lagrange coefficients for Lincheck tests");

    const std::vector<std::vector<FieldT>> random_linear_combinations = this->lincheck_A_->all_random_linear_combinations();
    libff_liop::enter_block("Checking predicate for Lincheck A");
    ...
    {
        libff_liop::print_indent(); printf("Interleaved Lincheck for A matrix failed\n");
        return false;
    }
    libff_liop::leave_block("Checking predicate for Lincheck A");

    libff_liop::enter_block("Checking predicate for Lincheck B");
    ...
    {
        libff_liop::print_indent(); printf("Interleaved Lincheck for B matrix failed\n");
        return false;
    }
    libff_liop::leave_block("Checking predicate for Lincheck B");

    libff_liop::enter_block("Checking predicate for Lincheck C");
    ...
    {
        libff_liop::print_indent(); printf("Interleaved Lincheck for C matrix failed\n");
        return false;
    }
    libff_liop::leave_block("Checking predicate for Lincheck C");

    libff_liop::enter_block("Checking predicate for Rowcheck");
    if (!this->rowcheck_->verifier_predicate())
    {
        libff_liop::print_indent(); printf("Interleaved Rowcheck failed\n");
        return false;
    }
    libff_liop::leave_block("Checking predicate for Rowcheck");
