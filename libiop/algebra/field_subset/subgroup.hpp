...
protected:
    void construct_internal(typename libff_liop::enable_if<libff_liop::is_multiplicative<FieldT>::value, FieldT>::type order,
        const FieldT generator = FieldT::zero());
    void construct_internal(typename libff_liop::enable_if<libff_liop::is_additive<FieldT>::value, FieldT>::type order,
        const FieldT generator = FieldT::zero());
};
