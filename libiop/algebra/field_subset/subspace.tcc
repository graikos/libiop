...
linear_subspace<FieldT> linear_subspace<FieldT>::standard_basis(const std::size_t dimension)
{
    ...
    assert(dimension <= libff_liop::log_of_field_size_helper<FieldT>(FieldT::zero()));
...
template<typename FieldT>
bool internal_element_in_subset(const typename libff_liop::enable_if<libff_liop::is_multiplicative<FieldT>::value, FieldT>::type x,
...
template<typename FieldT>
bool internal_element_in_subset(const typename libff_liop::enable_if<libff_liop::is_additive<FieldT>::value, FieldT>::type x,
    FieldT shift, size_t dimension)
{
