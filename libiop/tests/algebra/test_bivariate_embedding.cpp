...
TEST(MultiplicativeBivariateEmbedding, TestOrdering)
{
    ...
    multiplicative_bivariate_embedding_tests_for_field<libff_liop::edwards_Fr>(order, 1ull << dimension);
}

TEST(AdditiveBivariateEmbedding, TestOrdering)
{
    const size_t dimension = 10;
    additive_bivariate_embedding_tests_for_field<libff_liop::gf64>(dimension);
    additive_bivariate_embedding_tests_for_field<libff_liop::gf128>(dimension);
    additive_bivariate_embedding_tests_for_field<libff_liop::gf192>(dimension);
    additive_bivariate_embedding_tests_for_field<libff_liop::gf256>(dimension);
}
