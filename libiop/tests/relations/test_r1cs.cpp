...
TEST(R1CSGeneratorTest, SimpleTests) {
    for (std::size_t variable_dim = 8; variable_dim < 10; variable_dim++) {
        for (std::size_t constraint_dim = 8; constraint_dim < 10; constraint_dim++) {
            ...
            r1cs_example<libff_liop::gf64> r1cs_params_gf64 = generate_r1cs_example<libff_liop::gf64>(
            ...
            r1cs_example<libff_liop::edwards_Fr> r1cs_params_edwards = generate_r1cs_example<libff_liop::edwards_Fr>(
                num_constraints, num_inputs, num_variables);
            ...
            r1cs_example<libff_liop::alt_bn128_Fr> r1cs_params_alt_bn = generate_r1cs_example<libff_liop::alt_bn128_Fr>(
                num_constraints, num_inputs, num_variables);
