...
{
    libff_liop::enter_block("Finish prover round");
    ...
    for (auto &kv : mapping)
    {
        ...
        libff_liop::enter_block("Construct Merkle tree");
        ...
        libff_liop::leave_block("Construct Merkle tree");
    }

    this->run_hashchain_for_round();

    libff_liop::leave_block("Finish prover round");
    libff_liop::enter_block("pow");
...
{
    libff_liop::print_indent(); printf("* Total size of proof oracles (bytes): %zu\n", this->num_bytes_across_all_oracles());
    libff_liop::print_indent(); printf("* Total size of Merkle tree (bytes): %zu\n", this->MT_size());
    libff_liop::print_indent(); printf("* Total size of prover state (bytes): %zu\n", this->state_size());
}
