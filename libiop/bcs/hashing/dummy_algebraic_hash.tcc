...
void dummy_algebraic_hashchain<FieldT, hash_data_type>::absorb_internal(
    const typename libff_liop::enable_if<std::is_same<hash_data_type, FieldT>::value, hash_data_type>::type new_input)
{
...
template<typename FieldT, typename hash_data_type>
void dummy_algebraic_hashchain<FieldT, hash_data_type>::absorb_internal(
    const typename libff_liop::enable_if<std::is_same<hash_data_type, binary_hash_digest>::value, hash_data_type>::type new_input)
{
...
hash_data_type dummy_algebraic_hashchain<FieldT, hash_data_type>::squeeze_root_type_internal(
    const typename libff_liop::enable_if<std::is_same<hash_data_type, FieldT>::value, hash_data_type>::type dummy)
{
...
template<typename FieldT, typename hash_data_type>
hash_data_type dummy_algebraic_hashchain<FieldT, hash_data_type>::squeeze_root_type_internal(
    const typename libff_liop::enable_if<std::is_same<hash_data_type, binary_hash_digest>::value, hash_data_type>::type dummy)
{
