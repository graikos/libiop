...
template<typename FieldT>
FieldT string_to_field_elem(typename libff_liop::enable_if<libff_liop::is_multiplicative<FieldT>::value, FieldT>::type dummy_field_elem,
    const zk_salt_type &zk_salt);
template<typename FieldT>
FieldT string_to_field_elem(typename libff_liop::enable_if<libff_liop::is_additive<FieldT>::value, FieldT>::type dummy_field_elem,
    const zk_salt_type &zk_salt);
