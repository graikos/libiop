...
FieldT blake2b_FieldT_rejection_sample(
    typename libff_liop::enable_if<libff_liop::is_additive<FieldT>::value, FieldT>::type _,
...
template<typename FieldT>
FieldT blake2b_FieldT_rejection_sample(
    typename libff_liop::enable_if<libff_liop::is_multiplicative<FieldT>::value, FieldT>::type _,
    unsigned char* root_plus_index,
    size_t root_plus_index_size,
    const size_t key,
    const size_t key_increment)
