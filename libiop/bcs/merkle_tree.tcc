...
{
    if (num_leaves < 2 || !libff_liop::is_power_of_2(num_leaves))
    {
...
{
    libff_liop::enter_block("BCS: Sample randomness");
    ...
    * vector size. */
    ...
    libff_liop::leave_block("BCS: Sample randomness");
}
...
{
    return libff_liop::log2(this->num_leaves_);
}
