...
static void BM_gf256_mul_vec(benchmark::State &state)
{
    ...
    const std::vector<libff_liop::gf256> avec = random_vector<libff_liop::gf256>(sz);
    const std::vector<libff_liop::gf256> bvec = random_vector<libff_liop::gf256>(sz);

    std::vector<libff_liop::gf256> cvec(sz);
...
static void BM_gf256_mul_vec_data_dependency(benchmark::State &state)
{
    ...
    libff_liop::gf256 sum = libff_liop::gf256(0);
...
static void BM_gf256_mul(benchmark::State &state)
{
    ...
    const size_t sz = state.range(0);
    const std::vector<libff_liop::gf256> avec = random_vector<libff_liop::gf256>(num_elems);
    const std::vector<libff_liop::gf256> bvec = random_vector<libff_liop::gf256>(num_elems);
...
{
    const size_t sz = state.range(0);
    const std::vector<libff_liop::gf256> vec = random_vector<libff_liop::gf256>(sz);

    std::vector<libff_liop::gf256> result(sz);
